...
import { DEFAULT_RAINFALL_COLOR } from "../components/Background/visualizers/particles/Rainfall";
...
export default class Settings {
  ...
  shuffleDefaultBackgrounds: false,
      ...
      rainfallSpeed: 1,
      rainfallImage: null,
      rainfallImageScale: 1,
      rainfallColor: DEFAULT_RAINFALL_COLOR,
      autogeneratedTheme: false,
...
export interface ISettings {
  ...
  /**
   * When enabled, disables all additional rendering effects (visualizer, dynamic
   * lighting, and storyboard) to improve performance on lower-end hardware or
   * mobile devices.
   */
  ...
  /**
   * Enable the rainfall particle effect where drops fall from the top of the screen.
   */
  rainfallEffect: boolean;
  /**
   * How frequently rain drops spawn. Higher values create denser rainfall.
   */
  rainfallFrequency: number;
  /**
   * How fast rain drops fall. Higher values make the rain fall faster.
   */
  rainfallSpeed: number;
  /**
   * Optional custom image (absolute path) to use for each rain drop instead of the default streak.
   * null = use the default rain drop rendering.
   */
  rainfallImage: string | null;
  /**
   * Scale multiplier for the custom rainfall image.
   */
