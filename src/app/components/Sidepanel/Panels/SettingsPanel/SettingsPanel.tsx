      ...
      <Tabs onChange={(key) => window.localStorage.setItem("settings-tab-index", key)} defaultValue={window.localStorage.getItem("settings-tab-index") || "general"}>
        ...
        <Tabs.Panel value="Visuals">
          ...
          >
            ...
            <Checkbox 
              onClick={(e) => {
                Settings.apply({ autogeneratedTheme: e.currentTarget.checked }, true);
                // Trigger theme update immediately
                Toxen.applyAutogeneratedThemeIfEnabled();
              }} 
              defaultChecked={Settings.get("autogeneratedTheme")} 
              name="autogeneratedTheme" 
              label="Enable Autogenerated Theme (Global)" 
            />
            <sup>
              Globally enables autogenerated themes based on visualizer colors. This will be the default setting for all songs. 
              Individual songs can still override this setting.
            </sup>
