...
export class Toxen {
  ...
  public static subtitles: SubtitlesController;
  public static themeContainer: ThemeContainerController;
  ...
  render = () => {
    return (
      <div>
        ...
        <ThemeContainer onReady={controller => Toxen.themeContainer = controller} />
        <div
        ...
        >
          ...
          <SidepanelSection key="songPanel" id="songPanel" title="Music" icon={<IconMusic size="1em" />}>
            ...
            <SongQueuePanel onReady={controller => Toxen.songQueuePanel = controller} />
            <SongPanel onReady={controller => Toxen.songPanel = controller} />
          </SidepanelSection>
